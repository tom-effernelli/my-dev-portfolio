...
import DropdownMenuDevSelected from "./dropdown-menu-dev-selected";

const NavigationBarDevSelected = ({ className = "" }) => {
...
NavigationBarDevSelected.propTypes = {
  className: PropTypes.string,
};

export default NavigationBarDevSelected;
