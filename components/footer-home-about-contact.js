    ...
    >
      ...
      <div className="self-stretch flex-1 flex flex-col items-start lg:gap-2.5 md:gap-2.5 sm:gap-1 xs:gap-0.5 text-[29px] xs:text-[25px]">
        ...
        <div className="self-stretch flex-1 overflow-hidden flex items-end justify-center">
          ...
          <Link
            className="cursor-pointer [text-decoration:none] self-stretch w-[284px] xs:w-full border-[#fff] border-solid border-b-[2px] box-border overflow-hidden hidden flex-col items-start justify-end pt-0 px-0 pb-[5px] text-[inherit] xs:flex sm:flex-1 md:flex md:flex-1"
            id="pageButton"
            href="/dev"
          >
            <b className="self-stretch relative leading-[121.1%] lg:text-[26px] md:text-[23px] sm:text-[20px] xs:text-[18px]">
        ...
        <div className="self-stretch flex-1 overflow-hidden flex items-end justify-center">
          ...
          <div className="self-stretch w-[284px] xs:w-full border-[#fff] border-solid border-b-[2px] box-border overflow-hidden hidden flex-col items-start justify-end pt-0 px-0 pb-[5px] cursor-pointer xs:flex sm:flex-1 sm:cursor-auto md:flex md:flex-1 md:cursor-auto">
            <div className="flex items-center py-0 pl-[7px] pr-0 gap-5">
              <button
