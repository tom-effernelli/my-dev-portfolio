...
import DropdownMenuModelSelected from "./dropdown-menu-model-selected";

const NavigationBarModelSelected = ({ className = "" }) => {
...
NavigationBarModelSelected.propTypes = {
  className: PropTypes.string,
};

export default NavigationBarModelSelected;
